// ==========================================
// 🧠 MASSIVE 180-QUESTION SEPARATED DATABASE 
// ==========================================
const customDatabase = [
    // ---------------------------------------------------------
    // 🪙 BLOCKCHAIN CATEGORY (60 Questions: 42 Crypto / 18 Fun)
    // ---------------------------------------------------------
    ...
    // -- Blockchain Category: Fun Trivia Buffer (18 Questions) --
    ...
    // ---------------------------------------------------------
    // 🎮 GAMING CATEGORY (60 Questions: 100% Gaming)
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // 🎪 FUN TRIVIA CATEGORY (60 Questions: 100% Trivia)
    // ---------------------------------------------------------
    ...
    { cat: "trivia", dat: "trivia", q: "What is the chemical symbol for Silver?", correct: "Ag", incorrect: ["Au", "Si", "Sv"] },
...
// Export logic to deliver questions safely to server.js
...
module.exports = { getCustomQuestion };
